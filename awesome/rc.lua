...
todo = os.getenv("HOME") .. "/local/bin/emacs-console -s emacsconsole ~/Documents/Org"
editor = os.getenv("EDITOR") or "editor"
editor_cmd = terminal .. " -e " .. editor
screenlock = "gnome-screensaver-command --lock"
passman = os.getenv("HOME") .. "/local_Linux-x86_64/bin/keepassx"
...
tags[1] = awful.tag({ "web", "code 1", "code 2", "code 3", "code 4" }, 1, awful.layout.suit.tile)
if screen.count() >= 2 then
   tags[2] = awful.tag({ "mail", "code A", "code B", "code C", "code D" }, 2, awful.layout.suit.tile)
end
